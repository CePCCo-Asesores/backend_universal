...
class AuthController
{
    ...
    {
        try {
            // === NUEVO: validación de CSRF state (si venimos de /auth/google) ===
    ...
    private function exchangeCodeForToken(string $authCode): ?array
    {
        ...
        $redirectUri = getenv('GOOGLE_REDIRECT_URI') ?: 'https://tu-backend.up.railway.app/auth/google/callback';
...
// No cambia tu lógica; solo permite usar controller: "AuthController"
// en routes.yaml si tu autoloader no resuelve namespaces.
// ==============================
namespace {
